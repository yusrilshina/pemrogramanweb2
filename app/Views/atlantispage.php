        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-pills nav-secondary nav-pills-no-bd" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#tab1" role="tab">Tomorrow War</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="pill" href="#tab2" role="tab">Greyhound</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content mt-2 mb-3">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <p style="color: red">A family man is drafted to fight in a future war where the fate of
                            humanity
                            relies on his ability to confront the past</p>
                    </div>

                    <div class="tab-pane fade" id="tab2" role="tabpanel">
                        <p style="color: green">Several months after the U.S. entry into World War II, an inexperienced
                            U.S. Navy commander must lead an Allied convoy being stalked by a German submarine wolf pack
                        </p>
                    </div>

                    <div class="tab-pane fade" id="tab3" role="tabpanel">
                        <p style="color: blue">A prequel, set before the events of Army of the Dead, which focuses on
                            German safecracker Ludwig Dieter leading a group of aspiring thieves on a top secret heist
                            during
                            the early stages of the zombie apocalypse</p>
                    </div>
                </div>
            </div>
        </div>
